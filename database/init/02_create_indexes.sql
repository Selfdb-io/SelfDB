...
-- CORS Origins table indexes
CREATE INDEX IF NOT EXISTS idx_cors_origins_active ON cors_origins(is_active);
CREATE INDEX IF NOT EXISTS idx_cors_origins_created_by ON cors_origins(created_by);
CREATE INDEX IF NOT EXISTS idx_cors_origins_created_at ON cors_origins(created_at);
